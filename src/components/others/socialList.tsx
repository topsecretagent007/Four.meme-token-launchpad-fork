			...
			{(data?.twitter && data?.twitter !== undefined) &&
				<Link href={data?.twitter} legacyBehavior passHref>
					<a
						...
						className="text-2xl text-white bg-white/30 hover:text-blue-500 hover:border-blue-500 hover:bg-blue-500/30 p-2 cursor-pointer rounded-full border-[1px] border-white"
					>
						<FaXTwitter />
					</a>
				</Link>
