        ...
        <div className="flex flex-row w-full items-center justify-between">
          <div className="flex flex-row gap-2 items-center px-1">
            <Image
              ...
              height={32}
            />
            <div className="text-sm text-[#f52a6d]">
              {msg.sender && (msg.sender as userInfo).name}
            </div>
          </div>
          {msg.time && <div className="text-sm text-[#f52a6d]">
            {/* {msg.time.toString()} */}
            {postTime}
          </div>}
        </div>

        <div className="flex flex-col 3xs:flex-row w-full border-[1px] border-[#f52a6d] rounded-lg object-cover overflow-hidden items-start justify-start p-3 gap-3">
          {(msg?.img !== undefined) && (
            <Image
          ...
          <div className="w-full h-full flex flex-col text-white font-semibold text-sm">
            {msg.msg}
          </div>
        </div>
      </div>
